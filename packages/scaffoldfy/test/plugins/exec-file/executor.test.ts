...
import type { ExecFileConfig } from '../../../src/plugins/exec-file/types.js';
import type { InitConfig, TaskDefinition } from '../../../src/types.js';
import fs from 'node:fs';
import path from 'node:path';
import { afterEach, beforeEach, describe, expect, it } from 'vitest';
import { executeExecFile } from '../../../src/plugins/exec-file/executor.js';

const TEST_DIR = path.join(process.cwd(), '__test_exec_file__');
